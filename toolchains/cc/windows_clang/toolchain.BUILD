...
config_setting(
    ...
    flag_values = {
        "@goldfish_build//toolchains/cc/windows_clang:hermetic_msvc": "true",
    },
)
...
alias(
    ...
    actual = select({
        ":is_hermetic_msvc": "@vctools_hermetic//:msvc_runtimes_x64",
        "//conditions:default": "@vctools//:msvc_runtimes_x64",
    }),
)
...
alias(
    name = "ml64",
    actual = select({
        ":is_hermetic_msvc": "@vctools_hermetic//:ml64",
        "//conditions:default": "@vctools//:ml64",
    }),
)
...
alias(
    name = "msdia",
    actual = select({
        ":is_hermetic_msvc": "@vctools_hermetic//:msdia",
        "//conditions:default": "@vctools//:msdia",
    }),
)
...
alias(
    ...
    actual = select({
        ...
        "//conditions:default": "@windows_sdk//:sdk_libs_x64",
    }),
)
...
alias(
    ...
    actual = select({
        ":is_hermetic_msvc": "@windows_sdk_hermetic//:resource_compiler_toolchain_x64",
        "//conditions:default": "@windows_sdk//:resource_compiler_toolchain_x64",
    }),
)
...
cc_toolchain(
    ...
    strip_files = "@goldfish_build//toolchains/cc:empty",
...
toolchain(
    ...
    toolchain = ":resource_compiler_toolchain_x64",
    toolchain_type = "@goldfish_build//toolchains/cc/windows_clang:resource_compiler_toolchain_type",
)
